...
abstract class REST_Controller extends CI_Controller {
    ...
    protected function _check_login($username = NULL, $password = FALSE)
    {
		...
		/*Custom code to get driver login username and password Start*/
		
		/* $this->load->model('Driver_model');
		$valid_logins = $this->Driver_model->getValidLogins();
	 */
		/*Custom code to get driver login username and password End*/
